...
import { BooksFill, CalendarBlank, MagnifyingGlass, UsersThree } from "@/components/icons";
import {
  CHEMIN_COMMUNAUTE,
  PANNEAUX,
  TITRE_COLLECTION,
...
const ONGLETS = [
  ...
  { href: CHEMIN_COMMUNAUTE, libelle: TITRE_COMMUNAUTE, Icone: UsersThree },
] as const;
...
export function TabBar() {
  ...
  return (
    <nav className="bg-header border-divider sticky bottom-0 flex border-t pt-[8px] pb-[calc(18px+env(safe-area-inset-bottom))]">
